...
class PickUpPage extends StatefulWidget {
  ...
  PickUpPage(
      {this.ride,
      this.onContinueRectChange = onChangeDefault,
      this.highlightPickUpButton = false,
      this.highlightScheduleButton = false});
  @override
                ...
                SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 16),
                        widget.highlightScheduleButton
                            ? Row(children: [
                                Spacer(),
                                MeasureRect(
                        ...
                        Padding(
                          ...
                          child: Column(children: [
                            ...
                            Row(children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  widget.ride.rider.accessibilityNeeds.length >
                                          0
                                      ? Padding(
                            ...
                            SizedBox(height: 40),
                            RideStops(ride: widget.ride, carIcon: true),
                          ]),
                        ),
                      ],
                    ),
